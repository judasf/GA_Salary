...
public class ExcelHelper
{
    ...
    /// 导出EXCEL_接入网机房基础信息
    /// </summary>
    /// <param name="dataSources">datatable</param>
    /// <returns></returns>
    private static MemoryStream ExportForAccessStation(DataTable dt)
    {

        HttpContext context = HttpContext.Current;
        FileStream file = new FileStream(context.Server.MapPath("~") + @"Template/AccessStation_Tmp.xls", FileMode.Open, FileAccess.Read);
        HSSFWorkbook workbook = new HSSFWorkbook(file);
        ...
        using (MemoryStream ms = new MemoryStream())
        {
            ...
            ms.Flush();
            ms.Position = 0;
            //workbook.re();//一般只用写这一个就OK了，他会遍历并释放所有资源，但当前版本有问题所以只释放sheet
            return ms;
        }
    }
    /// <summary>
    ...
    /// <param name="dataSources">datatable</param>
    /// <returns></returns>
    private static MemoryStream ExportForAccessStationElec(DataTable dt)
    {

        HttpContext context = HttpContext.Current;
        FileStream file = new FileStream(context.Server.MapPath("~") + @"Template/AccessStationElec_Tmp.xls", FileMode.Open, FileAccess.Read);
        HSSFWorkbook workbook = new HSSFWorkbook(file);
        #region 右击文件 属性信息
        {
            DocumentSummaryInformation dsi = PropertySetFactory.CreateDocumentSummaryInformation();
    ...
    /// <summary>
    /// 导出EXCEL_接入网机房上年最后一次缴费电费台账
    /// </summary>
    /// <param name="dataSources">datatable</param>
    /// <returns></returns>
    private static MemoryStream ExportForAccessStationLastElec(DataTable dt)
    {

        HttpContext context = HttpContext.Current;
        FileStream file = new FileStream(context.Server.MapPath("~") + @"Template/AccessStationLastElec_Tmp.xls", FileMode.Open, FileAccess.Read);
        HSSFWorkbook workbook = new HSSFWorkbook(file);
        #region 右击文件 属性信息
        {
            DocumentSummaryInformation dsi = PropertySetFactory.CreateDocumentSummaryInformation();
    ...
    /// 导出Excel接入网机房基础信息表
    /// </summary>
    /// <param name="dtSources">DataTable</param>
    /// <param name="strFileName">文件名</param>
    public static void ExportByWebForAccessStation(DataTable dtSources, string strFileName)
    {
        ...
        curContext.Response.AppendHeader("Content-Disposition",
            "attachment;filename=" + HttpUtility.UrlEncode(strFileName, Encoding.UTF8));
        curContext.Response.Clear();
        curContext.Response.BinaryWrite(ExportForAccessStation(dtSources).GetBuffer());
        curContext.Response.End();
    ...
    /// <param name="dtSources">DataTable</param>
    /// <param name="strFileName">文件名</param>
    public static void ExportByWebForAccessStationElec(DataTable dtSources, string strFileName)
    {
        ...
        curContext.Response.AppendHeader("Content-Disposition",
            "attachment;filename=" + HttpUtility.UrlEncode(strFileName, Encoding.UTF8));
        curContext.Response.Clear();
        curContext.Response.BinaryWrite(ExportForAccessStationElec(dtSources).GetBuffer());
        curContext.Response.End();

    }
    /// <summary>
    /// 导出Excel接入网机房上年最后一次缴费电费台账
    /// </summary>
    /// <param name="dtSources">DataTable</param>
    /// <param name="strFileName">文件名</param>
    public static void ExportByWebForAccessStationLastElec(DataTable dtSources, string strFileName)
    {
        ...
        curContext.Response.AppendHeader("Content-Disposition",
            "attachment;filename=" + HttpUtility.UrlEncode(strFileName, Encoding.UTF8));
        curContext.Response.Clear();
        curContext.Response.BinaryWrite(ExportForAccessStationLastElec(dtSources).GetBuffer());
        curContext.Response.End();
    ...
    /// <param name="dtSources">DataTable</param>
    /// <param name="strFileName">文件名</param>
    public static void ExportByWebForRetainStation(DataTable dtSources, string strFileName)
    {
        ...
        curContext.Response.AppendHeader("Content-Disposition",
            "attachment;filename=" + HttpUtility.UrlEncode(strFileName, Encoding.UTF8));
        curContext.Response.Clear();
        curContext.Response.BinaryWrite(ExportForRetainStation(dtSources).GetBuffer());
        curContext.Response.End();
    ...
    /// <param name="dataSources">datatable</param>
    /// <returns></returns>
    private static MemoryStream ExportForRetainStation(DataTable dt)
    {

        HttpContext context = HttpContext.Current;
        FileStream file = new FileStream(context.Server.MapPath("~") + @"Template/RetainStation_Tmp.xls", FileMode.Open, FileAccess.Read);
        HSSFWorkbook workbook = new HSSFWorkbook(file);
        //XSSFWorkbook workbook = new XSSFWorkbook(file);
        #region 右击文件 属性信息
        {
    ...
    /// <param name="dtSources">DataTable</param>
    /// <param name="strFileName">文件名</param>
    public static void ExportByWebForRetainStationElec(DataTable dtSources, string strFileName)
    {
        ...
        curContext.Response.AppendHeader("Content-Disposition",
            "attachment;filename=" + HttpUtility.UrlEncode(strFileName, Encoding.UTF8));
        curContext.Response.Clear();
        curContext.Response.BinaryWrite(ExportForRetainStationElec(dtSources).GetBuffer());
        curContext.Response.End();
    ...
    /// <param name="dataSources">datatable</param>
    /// <returns></returns>
    private static MemoryStream ExportForRetainStationElec(DataTable dt)
    {

        HttpContext context = HttpContext.Current;
        FileStream file = new FileStream(context.Server.MapPath("~") + @"Template/RetainStationElec_Tmp.xls", FileMode.Open, FileAccess.Read);
        HSSFWorkbook workbook = new HSSFWorkbook(file);
        #region 右击文件 属性信息
        {
            DocumentSummaryInformation dsi = PropertySetFactory.CreateDocumentSummaryInformation();
    ...
    /// <summary>
    /// 导出Excel保留基站上年最后一次缴费电费台账
    /// </summary>
    /// <param name="dtSources">DataTable</param>
    /// <param name="strFileName">文件名</param>
    public static void ExportByWebForRetainStationLastElec(DataTable dtSources, string strFileName)
    {
        ...
        curContext.Response.AppendHeader("Content-Disposition",
            "attachment;filename=" + HttpUtility.UrlEncode(strFileName, Encoding.UTF8));
        curContext.Response.Clear();
        curContext.Response.BinaryWrite(ExportForRetainStationLastElec(dtSources).GetBuffer());
        curContext.Response.End();

    } /// <summary>
      /// 导出EXCEL_保留基站上年最后一次缴费电费
      /// </summary>
      /// <param name="dataSources">datatable</param>
      /// <returns></returns>
    private static MemoryStream ExportForRetainStationLastElec(DataTable dt)
    {

        HttpContext context = HttpContext.Current;
        FileStream file = new FileStream(context.Server.MapPath("~") + @"Template/RetainStationLastElec_Tmp.xls", FileMode.Open, FileAccess.Read);
        HSSFWorkbook workbook = new HSSFWorkbook(file);
        #region 右击文件 属性信息
        {
            DocumentSummaryInformation dsi = PropertySetFactory.CreateDocumentSummaryInformation();
